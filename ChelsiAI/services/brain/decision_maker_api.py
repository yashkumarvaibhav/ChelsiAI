...
def make_decision_chelsiai(secret_key, string):
    try:
...
def make_decision_chelsiai_string_matching(classes_list, input_string):
    try:
        answer = []
        answer_ = {}
        answer_li = []
...
if __name__ == "__main__":
    ...
    pprint(make_decision_chelsiai('5ba317a681c5d42361cda5b9f9ba7d0e', inp))
